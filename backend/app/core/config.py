...
class Settings(BaseSettings):
    ...
    SECRET_KEY: str
    # Clave con la que se cifran los secretos guardados en la BD (API keys por bot/proveedor).
    # Vacío = se deriva de SECRET_KEY (comportamiento anterior). Recomendado definirla aparte.
    # Si se define después, lo ya cifrado sigue descifrándose (se prueba también con SECRET_KEY).
    ENCRYPTION_KEY: str = ""
    ALGORITHM: str = "HS256"
